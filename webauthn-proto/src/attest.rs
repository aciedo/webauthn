...
pub struct RegisterPublicKeyCredential {
    ...
    /// used in a real registration, because the true credential ID is taken
...
impl From<web_sys::PublicKeyCredential> for RegisterPublicKeyCredential {
    fn from(data: web_sys::PublicKeyCredential) -> RegisterPublicKeyCredential {
        ...
        // AuthenticatorAttestationResponse has getTransports but web_sys isn't exposing
        // it?
        let transports = None;
        ...
        let data_response_attestation_object_b64 = data_response_attestation_object;

        let data_response_client_data_json_b64 = data_response_client_data_json;

        RegisterPublicKeyCredential {
            id: to_b64(&data_raw_id),
            raw_id: data_raw_id,
