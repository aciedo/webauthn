...
pub enum COSEAlgorithm {
    ...
    EDDSA = -8,
    /// Identifies this as an INSECURE RS1 aka RSASSA-PKCS1-v1_5 using SHA-1.
    /// This is not used by validators, but can exist in some windows hello
    /// tpm's
    InsecureRs1 = -65535,
    ...
    ///
    /// This reports as algorithm `-25`, but it is a lie. Don't include this in
    /// any algorithm lists.
    PinUvProtocol,
}
...
impl COSEAlgorithm {
    ...
    /// Return the set of all possible algorithms that may exist as a
    /// COSEAlgorithm
...
impl TryFrom<i128> for COSEAlgorithm {
    ...
    fn try_from(i: i128) -> Result<Self, Self::Error> {
        match i {
            ...
            -65535 => Ok(COSEAlgorithm::InsecureRs1),
            _ => Err(()),
        }
    }
}
