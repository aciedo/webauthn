...
impl RequestAuthenticationExtensionsBuilder {
    pub fn new() -> Self {
        Self(RequestAuthenticationExtensions { appid: None })
    }
    ...
    /// Set the AppId extension, for backwards compatibility with FIDO U2F
    /// credentials
    ///
    /// # Example
    /// ```
    /// # use webauthn_core::proto::RequestAuthenticationExtensions;
    ...
    /// assert_eq!(
    ///     extensions.appid,
    ///     Some(String::from("https://domain.tld/app-id.json"))
    /// );
    /// ```
...
impl RequestRegistrationExtensionsBuilder {
    ...
    /// # Example
    /// ```
    /// # use webauthn_core::proto::{RequestRegistrationExtensions, CredentialProtectionPolicy, CredProtect};
