...
// The certificate data itself (as linked in the cert listing linked above) can
// be found at https://www.apple.com/certificateauthority/Apple_WebAuthn_Root_CA.pem.
